         ...
         <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
               <div class="container">
                  ...
                  <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/Lucky Juan.png" alt=""> </a>
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="panel">
                           <div class="panel-heading">
                              <h4 class="panel-title"><a data-parent="#accordion" data-toggle="collapse" class="panel-toggle collapsed" href="#faq1" aria-expanded="false"><i class="ti-info-alt" aria-hidden="true"></i>Can I order a lot of foods?</a></h4>
                           </div>
                           <div class="panel-collapse collapse" id="faq1" aria-expanded="false" role="article" style="height: 0px;">
                              <div class="panel-body">Yes, as long as you pay for everything you order! :)</div>
                           </div>
                        </div>
                        <!-- end:panel -->
                        <div class="panel">
                           <div class="panel-heading">
                              <h4 class="panel-title"><a data-parent="#accordion" data-toggle="collapse" class="panel-toggle" href="#faq2" aria-expanded="true"><i class="ti-info-alt" aria-hidden="true"></i>What is the payment option here at your restaurant?</a></h4>
                           </div>
                           <div class="panel-collapse collapse" id="faq2" aria-expanded="true" role="article">
                              <div class="panel-body">So far our only payment option is COD</div>
                           </div>
                        </div>
                        <!-- end:Panel -->
                ...
                <div class="container">
                    ...
                    <div class="row top-footer">
                        <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                            <a href="#"> <img src="images/Lucky Juan.png" alt="Footer logo"> </a> <span>Order Delivery &amp; Take-Out </span> </div>
                        ...
                        <div class="col-xs-12 col-sm-3 popular-locations color-gray">
                            <h5>Location</h5>
                            <ul>
                                <li><a href="https://www.google.com/maps/@16.0167139,120.4158291,3a,75y,114.83h,73.23t/data=!3m6!1e1!3m4!1sNBJfQbl3D5iRmyjN_lHOdQ!2e0!7i16384!8i8192">Gueguesangen, Sta. Barbara Pangasinan (near Sta. Barbara inn)</a> </li>   
                            </ul>
                        </div>
                    </div>
                    <!-- top footer ends -->
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-xs-12 col-sm-3 payment-options color-gray">
                                    <h5>Payment</h5>
                                    <ul>
                                            <a href="#"> <img src="images/cod12.png" alt="COD"> </a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Contact</h5>
                                    <p><a href="https://www.facebook.com/luckyjuaneatery">Facebook</a></p>
                                    <h5>Phone: <a href="tel:09690461585">09690461585</a></h5> </div>
